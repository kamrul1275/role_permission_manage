<div class="content container-fluid">
  ...
  <div class="page-header">
    <div class="row">
      <div class="col">
        <h3 class="page-title">Edit Page-wise Permission</h3>
        <ul class="breadcrumb">
    ...
    <div class="col-md-8">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title mb-0">Update Page Permission</h4>
        </div>

        <div class="card-body">
          <form wire:submit.prevent="updatePagePermission">
            ...
            <div class="text-end">
              ...
              <a href="{{ route('page_wise_permission') }}" class="btn btn-secondary ms-2">Cancel</a>
            </div>
